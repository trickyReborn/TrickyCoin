...
// trickycoin: total coins staked (non-spendable until maturity)
...
// trickycoin: check 'spent' consistency between wallet and txindex
// trickycoin: fix wallet spent state according to txindex
...
// trickycoin: disable transaction (only for coinstake)
